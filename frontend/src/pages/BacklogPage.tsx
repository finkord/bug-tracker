    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-in fade-in duration-200">
      ...
      {loading ? (
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-3 rounded-3xl bg-[var(--md-sys-color-surface-container-low)] border border-[var(--md-sys-color-outline-variant)]/20 shadow-xs">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-xs font-bold transition-all flex items-center gap-2 cursor-pointer border ${
                      isSelected
                        ...
                        : 'bg-[var(--md-sys-color-surface-container)] dark:bg-[var(--md-sys-color-surface-container-high)] text-[var(--md-sys-color-on-surface)] hover:bg-[var(--md-sys-color-surface-container-high)] dark:hover:bg-[var(--md-sys-color-surface-container-highest)] border-[var(--md-sys-color-outline-variant)]/40'
                    }`}
                  >
                    <span>{sName}</span>
                    <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${
                      isSelected ? 'bg-black/20 text-white' : 'bg-[var(--md-sys-color-surface-container-highest)] text-[var(--md-sys-color-on-surface-variant)]'
                    }`}>
                      {count}
                    </span>
                  </button>
            ...
            <button
              ...
              className="text-xs font-semibold text-[var(--md-sys-color-primary)] hover:underline flex items-center gap-1 px-3 py-1.5 rounded-full hover:bg-[var(--md-sys-color-surface-container)] transition-colors cursor-pointer"
            >
          ...
          <div className="p-6 rounded-3xl bg-[var(--md-sys-color-surface-container-low)] border border-[var(--md-sys-color-outline-variant)]/20 space-y-5 shadow-xs">
            <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-[var(--md-sys-color-surface-container-high)]">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <div className="px-3.5 py-1.5 rounded-2xl bg-[var(--md-sys-color-surface-container)] dark:bg-[var(--md-sys-color-surface-container-high)] border border-[var(--md-sys-color-outline-variant)]/40 text-xs">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full text-xs font-semibold flex items-center gap-1.5 text-[var(--md-sys-color-primary)] bg-[var(--md-sys-color-surface-container)] dark:bg-[var(--md-sys-color-surface-container-high)] hover:bg-[var(--md-sys-color-surface-container-highest)] border border-[var(--md-sys-color-outline-variant)]/40 cursor-pointer transition-colors"
                >
                ...
                {currentSprintDef.status === 'ACTIVE' && (
                  <button
                    ...
                    className="px-4 py-2 rounded-full text-xs font-semibold flex items-center gap-1.5 bg-[var(--md-sys-color-success-container)] text-[var(--md-sys-color-on-success-container)] hover:opacity-90 cursor-pointer transition-opacity"
                  >
                ...
                {currentSprintDef.status === 'COMPLETED' && (
                  <span className="px-3.5 py-1.5 rounded-full text-xs font-bold bg-[var(--md-sys-color-tertiary-container)] text-[var(--md-sys-color-on-tertiary-container)] flex items-center gap-1">
                    <CheckCircle2 className="w-3.5 h-3.5" />
            ...
            {sprintIssues.length === 0 ? (
              <div className="p-8 rounded-2xl bg-[var(--md-sys-color-surface-container)]/50 text-center text-xs text-[var(--md-sys-color-on-surface-variant)]">
                ...
                {sprintIssues.map((issue) => (
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <span className="font-mono text-xs font-bold text-[var(--md-sys-color-primary)] px-2.5 py-0.5 rounded-full bg-[var(--md-sys-color-primary-container)]/50 shrink-0">
                        {issue.key}
                      </span>
                    ...
                    <div className="flex items-center gap-3 shrink-0 text-xs">
                      ...
                      <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-[var(--md-sys-color-surface-container-highest)] text-[var(--md-sys-color-on-surface)]">
                        {issue.status}
                      </span>
                      ...
                      <button
                        ...
                        className="px-3 py-1 rounded-full text-[11px] font-semibold text-[var(--md-sys-color-on-surface-variant)] bg-[var(--md-sys-color-surface-container-lowest)] hover:bg-[var(--md-sys-color-surface-container-highest)] hover:text-[var(--md-sys-color-on-surface)] border border-[var(--md-sys-color-outline-variant)]/40 transition-colors flex items-center gap-1 cursor-pointer"
          ...
          <div className="p-6 rounded-3xl bg-[var(--md-sys-color-surface-container-low)] border border-[var(--md-sys-color-outline-variant)]/20 space-y-4 shadow-xs">
            <div className="flex items-center justify-between pb-3 border-b border-[var(--md-sys-color-surface-container-high)]">
              ...
              <button
                type="button"
                onClick={() => setCreateModalOpen(true)}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold text-[var(--md-sys-color-primary)] hover:bg-[var(--md-sys-color-surface-container)] cursor-pointer transition-colors"
              >
                <PlusCircle className="w-3.5 h-3.5" />
                <span>Add Task</span>
              </button>
            ...
            {backlogIssues.length === 0 ? (
              <div className="p-8 rounded-2xl bg-[var(--md-sys-color-surface-container)]/50 text-center text-xs text-[var(--md-sys-color-on-surface-variant)] italic">
              ...
              <div className="space-y-2.5">
                {backlogIssues.map((issue) => (
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <span className="font-mono text-xs font-bold text-[var(--md-sys-color-on-surface-variant)] px-2.5 py-0.5 rounded-full bg-[var(--md-sys-color-surface-container-highest)] shrink-0">
                        {issue.key}
                      </span>
                      <span className="text-xs font-semibold text-[var(--md-sys-color-on-surface)] group-hover:text-[var(--md-sys-color-primary)] transition-colors truncate">
                        {issue.title}
                    ...
                    <div className="flex items-center gap-3 shrink-0 text-xs">
                      ...
                      <button
                        ...
                        className="px-3.5 py-1.5 rounded-full text-xs font-semibold m3-btn-filled flex items-center gap-1.5 shadow-2xs cursor-pointer"
