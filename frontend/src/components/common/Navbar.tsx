  ...
  return (
    <header className="sticky top-0 z-40 w-full px-2 sm:px-4 py-2 sm:py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-3 sm:px-6 py-2 sm:py-3 rounded-full m3-card transition-colors">
        {/* Brand - Hidden on mobile view to leave maximum place for buttons */}
        <Link to="/" className="hidden sm:flex items-center gap-3 group shrink-0">
        ...
        {/* Right Navigation & Controls - On mobile takes full width to comfortably lay out buttons */}
        <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          {user ? (
            ...
            <div className="flex items-center gap-2">
              <Link
                to="/login"
                className={`px-3.5 sm:px-4 py-2 rounded-full text-xs font-semibold transition-all ${
                  isActive('/login')
              ...
              <Link
                to="/register"
                className="px-4 py-2 rounded-full text-xs font-semibold m3-btn-filled shadow-sm whitespace-nowrap"
              >
                Create Account
              </Link>
            </div>
